...
namespace JDKDownloader
{
   ...
   public class ConsoleDownloadProgressBar : IDisposable, IProgress<ProgressData>
   {
      ...
      public ConsoleDownloadProgressBar()
      {
      ...
      public void Report(ProgressData value)
      {
         ...
         value.Percent = Math.Max(0, Math.Min(1, value.Percent));
         Interlocked.Exchange(ref currentProgress, value.Percent);
         Interlocked.Exchange(ref progressData, value);
      }
